...
Use [Premium Package – Complete Digital Store Solution](http://www.wpdownloadmanager.com/download/premium-package-wordpress-digital-store-solution/) Add-on (free) if you need to sell your digital items. The add-on has all features you will ever need to build a perfect online shop for your digital downloads:
...
= OneDrive =
Use [OneDrive Explorer](http://www.wpdownloadmanager.com/download/wpdm-onedrive/) add-on ( free ) to store your files in Microsoft OneDrive and link with download manager, get 15 GB free storage space and save your server bandwidth
...
= More Themes & Add-ons =
* [Add-ons](http://www.wpdownloadmanager.com/downloads/add-ons/) - 100+ add-ons
* [Themes](http://www.wpdownloadmanager.com/downloads/themes/) - Themes Specially Optimized for Download Manager
...
* Fixed several issue with translation strings
* Improved admin UI
